...
var uiBlock = function () {
    ...
    function insert(dic) {
        ...
        function footer(selector) {
            i18n.run($(selector)
                ...
                .html(
                    ...
                    '<div class="copyright text-center">Copyright &copy; 2018</div>'));
        }
        ...
        function logoMain(selector) {
            ...
            localSave.setItem("initAddress", apiList[i].initAddress);
            ...
            i18n.run($(selector)
                ...
                .html(
                    "<div class=row>" +
                    "    <div class='col wall_head_title'>" +
                    "<span>区块链中文数字转换工具</span>" +
                        "</div>" +
                        "<div class='col wall_head_nav'><a href='https://www.nasscan.io'>主页</a><a href='https://wallet.nasscan.io'>钱包</a><a href='https://www.nasscan.io/#/material'>开发资料合集</a></div>" +
                    "    <div class=col>" +
                    "        <div class=dropdown>" +
        ...
        function selectWalletFile(selector, callback) {
            ...
            i18n.run($(selector)
                ...
                .html(
                    "<p>选择你的钱包文件：</p>" +
                    '<label class="file empty"><span>选择钱包文件...</span><input type=file></label>' +
                    '<label class="hide pass"><span>你的钱包加密了，好！请输入密码。</span><input type=password></label>' +
                    '<button class="btn btn-block">解锁</button>'
                    )
